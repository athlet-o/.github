...
- [GitHub Project: athlet-o-project](https://github.com/orgs/athlet-o/projects/1)
- [Linear planning project](https://linear.app/denman/project/githubcomathlet-o-b5a995fed9bb)
...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`athlet-o`](https://github.com/athlet-o) GitHub owner.

Planning and delivery context is tracked in [github.com/athlet-o](https://linear.app/denman/project/githubcomathlet-o-b5a995fed9bb). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/athlet-o/.github).
